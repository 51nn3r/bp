...
OUTPUT_DIR = f"{DIR_PREFIX}/04_peft_lora_b6_ft"
...
#  4. OPTIMIZER & SCALER
optimizer = Adam8bit([
    {"params": peft_model.parameters(), "lr": LEARNING_RATE, "weight_decay": 0.01}
])
...
for epoch in range(1, EPOCHS + 1):
    ...
    # save checkpoint
    peft_model.save_pretrained(os.path.join(OUTPUT_DIR, f"epoch{epoch}"))
